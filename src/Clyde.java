...
public class Clyde extends Thread {   
    ...
    public Clyde(int initialRow, int initialColumn, Maze startMaze) {
        ghostRow = initialRow;
        ...
        // livesLeft = lives;
        cells        = maze.getCells();
        ghostPicIcon = Toolkit.getDefaultToolkit().getImage(IMAGE_SOURCE + "clyde.png");
    }
